...
@SpringBootTest(classes = PropostaController.class)
class PropostaControllerTest {
    ...
    void get204SemCorpo() {
        ...
        ResponseEntity<List<Proposta>> resposta
                = controller.get();
    ...
    void put404SemCorpo() {
        ...
        ResponseEntity<Proposta> resposta = controller.put(idTeste, mock(Proposta.class));
    ...
    void put200ComCorpo() {
        ...
        ResponseEntity<Proposta> resposta = controller.put(idTeste, proposta);

        verify(repository, times(1)).save(proposta);
        assertEquals(200, resposta.getStatusCodeValue());
        assertNotNull(resposta.getBody());
        assertEquals(idTeste, resposta.getBody().getIdProposta());
    }
