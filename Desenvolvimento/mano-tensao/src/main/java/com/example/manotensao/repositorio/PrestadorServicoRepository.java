...
public interface PrestadorServicoRepository extends JpaRepository<PrestadorServico, Integer>{
    @Query("select new com.example.manotensao.dto.FiltroPorAvaliacao(ps.id, ps.nome, ps.email, ps.urlFoto, ps.telefone, avg(aps.notaPrestadorServico), ps.cep, ps.bairro, ps.rua, ps.numero) from AvaliacaoPrestadorServico aps " +
            ...
            "or s.idTipoServico = ?4 GROUP BY ps.id, ps.nome, ps.email, ps.urlFoto, ps.telefone, ps.cep, ps.bairro, ps.rua, ps.numero")
