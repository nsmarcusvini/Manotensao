...
@SpringBootTest(classes = AvaliacaoClienteController.class)
class AvaliacaoClienteControllerTest {

    @Autowired
    AvaliacaoClienteController controller;


    @MockBean
    AvaliacaoClienteRepository repository;
    ...
    void get204SemCorpo() {
        ...
        ResponseEntity<List<AvaliacaoCliente>> resposta
                = controller.get();
    ...
    void get200ComCorpo() {
        List<AvaliacaoCliente> lista = List.of(
                mock(AvaliacaoCliente.class),
                mock(AvaliacaoCliente.class)
        );
    ...
    void put404SemCorpo() {
        ...
        ResponseEntity<AvaliacaoCliente> resposta = controller.put(idTeste, mock(AvaliacaoCliente.class));
    ...
    void put200ComCorpo() {
        ...
        ResponseEntity<AvaliacaoCliente> resposta = controller.put(idTeste, avaliacaoCliente);

        verify(repository, times(1)).save(avaliacaoCliente);
        assertEquals(200, resposta.getStatusCodeValue());
        assertNotNull(resposta.getBody());
        assertEquals(idTeste, resposta.getBody().getIdAvaliacao());
    }
